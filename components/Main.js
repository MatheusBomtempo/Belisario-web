    ...
    <section className="text-gray-600 body-font font-sans">
      <div className="max-w-7xl mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
          ...
          <p className="mb-4 xl:w-3/4 text-gray-600 text-lg font-semibold">
            Somos um app de rotas para atendimento em serviços públicos de saúde baseado em sintomas descritos pelo usuário.
          </p>
          <div className="flex justify-center">
            ...
            >
              <span className="justify-center">Saiba Mais do App</span>
            </a>
          </div>
        </div>
      ...
      <section className="mx-auto">
        <div className="container px-5 mx-auto lg:px-24 ">
          <div className="flex flex-col w-full mb-4 text-left lg:text-center">
            <h1 className="mb-8 text-2xl font-sans font-semibold text-black">
      ...
      <div className="grr max-w-7xl pt-20 mx-auto text-center">
        ...
        <h1 className="mb-8 text-2xl font-sans font-semibold text-gray-600 text-center">
          Por conta de patente o lançamento foi adiado até segunda ordem.
        </h1>
